...
public class SignUpConfirm extends AppCompatActivity {
    ...
    private void sendConfCode() {
        ...
        Helper.getPool().getUser(userName).confirmSignUpInBackground(confirmCode, true, confHandler);
    }
    ...
    private void reqConfCode() {
        ...
        Helper.getPool().getUser(userName).resendConfirmationCodeInBackground(resendConfCodeHandler);
    ...
    GenericHandler confHandler = new GenericHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            showDialogMessage("Confirmation failed", Helper.formatException(exception), false);
        }
    };
    ...
    VerificationHandler resendConfCodeHandler = new VerificationHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            showDialogMessage("Confirmation code request has failed", Helper.formatException(exception), false);
        }
    };
